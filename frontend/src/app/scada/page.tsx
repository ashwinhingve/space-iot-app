        ...
        <div className="relative z-10 container mx-auto px-4 py-6 md:py-8 max-w-7xl">
          ...
          >
            ...
            <p className="text-muted-foreground ml-[52px]">
              Real-time monitoring and control of pump house systems
            </p>
          </motion.div>
          ...
          >
            <div className="relative mb-6">
              ...
              <div className="relative p-6 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-full border border-blue-500/20">
            ...
            <p className="text-muted-foreground text-center max-w-md">
              The Pump House SCADA interface is currently under development. This module will provide real-time monitoring, control, and data visualization for pump house operations.
            </p>
          </motion.div>
        </div>
      </div>
